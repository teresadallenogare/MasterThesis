...
def write_topology_file(N_row, N_col, N, pos_nodes, avg_pop_node, populationTot, choice_bool, Nfix, idxNfix, percentPopNfix, c1,
    ...
    folder_topology = datadir + f'/Data_simpleLattice_v1_cluster/{N_row}x{N_col}/choice_bool-{choice_bool}/c1-{c1}/Topology/'
...
def write_simulation_file(N_row, N_col, choice_bool, c1, node_pop0, node_S0, node_I0, node_R0, node_state0, T, beta, mu, nbr_repetitions,
    ...
    datadir = os.getcwd()
    folder_simulation = datadir + f'/Data_simpleLattice_v1_cluster/{N_row}x{N_col}/choice_bool-{choice_bool}/c1-{c1}/Simulations/mu-{mu}/beta-{beta}/'
