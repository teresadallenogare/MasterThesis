...
def write_topology_file(N_row, N_col, N, seed, avg_pop_node, choice_bool, Nfix, percentPopNfix, beta, mu, T, node_pop0,
                        node_S0, node_I0, node_R0, node_state0):

    datadir = os.getcwd()
    f = open(datadir + f'/Data-simpleLattice/{N_row}x{N_col}/topologyFile_{N_row}x{N_col}.txt', 'w')
