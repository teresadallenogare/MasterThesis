...
Stochastic SIR model with HMA approximation. (OpenAI)
...
if compare_DT_CT_SIR == 1:
    ...
    y_init = [(total_population - nbr_I0 - nbr_I0) / total_population, nbr_I0 / total_population, nbr_R0 / total_population]
    params = [beta, mu]
...
if stochastic_SIR == 1:
    ...
    for t in range(1, T):
        ...
        nbr_St_det[t], nbr_It_det[t], nbr_Rt_det[t] = deterministic_Reed_Frost(p, nbr_St_det[t - 1], nbr_It_det[t - 1], nbr_Rt_det[t - 1])
    ...
    for sim in range(nbr_repetitions):
        ...
        for t in range(1, T):
            ...
            nbr_St[sim, t], nbr_It[sim, t], nbr_Rt[sim, t] = stochastic_Reed_Frost(p, nbr_It[sim, t-1], nbr_St[sim, t-1], nbr_Rt[sim, t-1])
